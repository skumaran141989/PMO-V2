...
import pmo.project.repo.ResourceCalendarRepo.Month.Day;
import pmo.project.repo.ResourceCalendarRepo.Month.Day.Hour;

//Multilevel partitioned Resource Repo
public class ResourceCalendarRepo {
	private Map<Integer, Month> _years;
	private Map<String, List<String>> _totalResources;
	
	public ResourceCalendarRepo(){
